...
const Schema: z.ZodType<Prisma.TaskUncheckedCreateWithoutHistoryGroupsInput> = z
  .object({
...
export const TaskUncheckedCreateWithoutHistoryGroupsInputObjectSchema = Schema;
