...
const Schema: z.ZodType<Prisma.TaskUncheckedUpdateWithoutParticipantsInput> = z
  .object({
...
export const TaskUncheckedUpdateWithoutParticipantsInputObjectSchema = Schema;
