...
const Schema: z.ZodType<Prisma.UserInTaskTagUncheckedCreateNestedManyWithoutUserInTaskInput> = z
  .object({
    create: z
      .union([
...
export const UserInTaskTagUncheckedCreateNestedManyWithoutUserInTaskInputObjectSchema = Schema;
