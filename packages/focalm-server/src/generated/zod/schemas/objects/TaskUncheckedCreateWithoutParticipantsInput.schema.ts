...
const Schema: z.ZodType<Prisma.TaskUncheckedCreateWithoutParticipantsInput> = z
  .object({
...
export const TaskUncheckedCreateWithoutParticipantsInputObjectSchema = Schema;
