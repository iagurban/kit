...
const Schema: z.ZodType<Prisma.TaskHistoryGroupUncheckedUpdateManyWithoutTaskNestedInput> = z
  .object({
    create: z
      .union([
...
export const TaskHistoryGroupUncheckedUpdateManyWithoutTaskNestedInputObjectSchema = Schema;
