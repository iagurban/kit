...
const Schema: z.ZodType<Prisma.TaskUncheckedCreateWithoutHistoryValuesInput> = z
  .object({
...
export const TaskUncheckedCreateWithoutHistoryValuesInputObjectSchema = Schema;
