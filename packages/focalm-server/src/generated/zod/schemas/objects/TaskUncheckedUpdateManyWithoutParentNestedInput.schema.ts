...
const Schema: z.ZodType<Prisma.TaskUncheckedUpdateManyWithoutParentNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        ...
        z.lazy(() => TaskUpsertWithWhereUniqueWithoutParentInputObjectSchema).array(),
      ])
      .optional(),
    ...
    update: z
      .union([
        ...
        z.lazy(() => TaskUpdateWithWhereUniqueWithoutParentInputObjectSchema).array(),
      ])
      .optional(),
    updateMany: z
      .union([
        z.lazy(() => TaskUpdateManyWithWhereWithoutParentInputObjectSchema),
        z.lazy(() => TaskUpdateManyWithWhereWithoutParentInputObjectSchema).array(),
      ])
      .optional(),
    deleteMany: z
      .union([
...
export const TaskUncheckedUpdateManyWithoutParentNestedInputObjectSchema = Schema;
