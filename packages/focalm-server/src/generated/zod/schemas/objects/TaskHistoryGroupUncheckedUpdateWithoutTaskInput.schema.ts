...
const Schema: z.ZodType<Prisma.TaskHistoryGroupUncheckedUpdateWithoutTaskInput> = z
  .object({
...
export const TaskHistoryGroupUncheckedUpdateWithoutTaskInputObjectSchema = Schema;
