...
const Schema: z.ZodType<Prisma.TaskHistoryValueUncheckedUpdateManyWithoutValuesInput> = z
  .object({
...
export const TaskHistoryValueUncheckedUpdateManyWithoutValuesInputObjectSchema = Schema;
