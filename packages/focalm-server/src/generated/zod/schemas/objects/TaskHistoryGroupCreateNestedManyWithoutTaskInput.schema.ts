...
const Schema: z.ZodType<Prisma.TaskHistoryGroupCreateNestedManyWithoutTaskInput> = z
  .object({
    create: z
      .union([
...
export const TaskHistoryGroupCreateNestedManyWithoutTaskInputObjectSchema = Schema;
