...
const Schema: z.ZodType<Prisma.UserInTaskTagUncheckedUpdateManyWithoutUserInTaskNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserInTaskTagUncheckedUpdateManyWithoutUserInTaskNestedInputObjectSchema = Schema;
