...
const Schema: z.ZodType<Prisma.TaskHistoryValueUncheckedUpdateWithoutTaskInput> = z
  .object({
...
export const TaskHistoryValueUncheckedUpdateWithoutTaskInputObjectSchema = Schema;
