...
const Schema: z.ZodType<Prisma.TaskHistoryValueUpdateManyWithoutTaskNestedInput> = z
  .object({
    create: z
      .union([
...
export const TaskHistoryValueUpdateManyWithoutTaskNestedInputObjectSchema = Schema;
