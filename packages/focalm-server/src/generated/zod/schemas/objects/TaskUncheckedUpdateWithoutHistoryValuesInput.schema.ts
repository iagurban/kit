...
const Schema: z.ZodType<Prisma.TaskUncheckedUpdateWithoutHistoryValuesInput> = z
  .object({
...
export const TaskUncheckedUpdateWithoutHistoryValuesInputObjectSchema = Schema;
