...
const Schema: z.ZodType<Prisma.UploadedFileUpdateManyWithoutStoredFileNestedInput> = z
  .object({
    create: z
      .union([
...
export const UploadedFileUpdateManyWithoutStoredFileNestedInputObjectSchema = Schema;
