...
const Schema: z.ZodType<Prisma.TaskHistoryValueUncheckedUpdateWithoutGroupInput> = z
  .object({
...
export const TaskHistoryValueUncheckedUpdateWithoutGroupInputObjectSchema = Schema;
