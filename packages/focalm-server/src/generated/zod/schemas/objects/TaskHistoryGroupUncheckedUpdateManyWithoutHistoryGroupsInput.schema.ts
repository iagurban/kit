...
const Schema: z.ZodType<Prisma.TaskHistoryGroupUncheckedUpdateManyWithoutHistoryGroupsInput> = z
  .object({
...
export const TaskHistoryGroupUncheckedUpdateManyWithoutHistoryGroupsInputObjectSchema = Schema;
