...
const Schema: z.ZodType<Prisma.TaskUncheckedUpdateManyWithoutAssignedTasksInput> = z
  .object({
...
export const TaskUncheckedUpdateManyWithoutAssignedTasksInputObjectSchema = Schema;
