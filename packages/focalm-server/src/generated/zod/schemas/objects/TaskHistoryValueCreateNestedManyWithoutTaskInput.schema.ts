...
const Schema: z.ZodType<Prisma.TaskHistoryValueCreateNestedManyWithoutTaskInput> = z
  .object({
    create: z
      .union([
...
export const TaskHistoryValueCreateNestedManyWithoutTaskInputObjectSchema = Schema;
