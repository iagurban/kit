...
const Schema: z.ZodType<Prisma.TaskHistoryGroupUncheckedUpdateManyWithoutAuthoredTaskChangesInput> = z
  .object({
...
export const TaskHistoryGroupUncheckedUpdateManyWithoutAuthoredTaskChangesInputObjectSchema = Schema;
