...
const Schema: z.ZodType<Prisma.TaskUncheckedUpdateManyWithoutResponsibleNestedInput> = z
  .object({
    create: z
      .union([
...
export const TaskUncheckedUpdateManyWithoutResponsibleNestedInputObjectSchema = Schema;
