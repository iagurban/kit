...
const Schema: z.ZodType<Prisma.TaskCreateNestedManyWithoutResponsibleInput> = z
  .object({
    create: z
      .union([
...
export const TaskCreateNestedManyWithoutResponsibleInputObjectSchema = Schema;
