...
const Schema: z.ZodType<Prisma.TaskHistoryGroupUncheckedUpdateWithoutValuesInput> = z
  .object({
...
export const TaskHistoryGroupUncheckedUpdateWithoutValuesInputObjectSchema = Schema;
