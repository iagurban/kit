...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutParticipatingTasksInput> = z
  .object({
...
export const UserUncheckedCreateWithoutParticipatingTasksInputObjectSchema = Schema;
