...
const Schema: z.ZodType<Prisma.UserInTaskUncheckedUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserInTaskUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
