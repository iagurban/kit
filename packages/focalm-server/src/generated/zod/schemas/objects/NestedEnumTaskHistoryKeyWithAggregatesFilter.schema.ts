...
const Schema: z.ZodType<Prisma.NestedEnumTaskHistoryKeyWithAggregatesFilter> = z
  .object({
...
export const NestedEnumTaskHistoryKeyWithAggregatesFilterObjectSchema = Schema;
