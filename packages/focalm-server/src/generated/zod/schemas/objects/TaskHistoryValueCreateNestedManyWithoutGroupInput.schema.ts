...
const Schema: z.ZodType<Prisma.TaskHistoryValueCreateNestedManyWithoutGroupInput> = z
  .object({
    create: z
      .union([
...
export const TaskHistoryValueCreateNestedManyWithoutGroupInputObjectSchema = Schema;
