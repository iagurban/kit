...
import { TaskHistoryValueUncheckedUpdateManyWithoutGroupNestedInputObjectSchema } from './TaskHistoryValueUncheckedUpdateManyWithoutGroupNestedInput.schema';

const Schema: z.ZodType<Prisma.TaskHistoryGroupUncheckedUpdateWithoutAuthorInput> = z
  .object({
    ...
    createdAtFixReason: z
      ...
      .optional()
      .nullable(),
    values: z.lazy(() => TaskHistoryValueUncheckedUpdateManyWithoutGroupNestedInputObjectSchema).optional(),
  })
  .strict();

export const TaskHistoryGroupUncheckedUpdateWithoutAuthorInputObjectSchema = Schema;
