...
const Schema: z.ZodType<Prisma.TaskHistoryValueUncheckedCreateWithoutTaskInput> = z
  .object({
    groupId: z.string(),
...
export const TaskHistoryValueUncheckedCreateWithoutTaskInputObjectSchema = Schema;
