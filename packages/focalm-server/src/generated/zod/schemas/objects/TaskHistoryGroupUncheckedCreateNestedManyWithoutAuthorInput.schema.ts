...
const Schema: z.ZodType<Prisma.TaskHistoryGroupUncheckedCreateNestedManyWithoutAuthorInput> = z
  .object({
    create: z
      .union([
...
export const TaskHistoryGroupUncheckedCreateNestedManyWithoutAuthorInputObjectSchema = Schema;
