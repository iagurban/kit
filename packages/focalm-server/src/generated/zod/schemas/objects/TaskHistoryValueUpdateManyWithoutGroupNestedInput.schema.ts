...
const Schema: z.ZodType<Prisma.TaskHistoryValueUpdateManyWithoutGroupNestedInput> = z
  .object({
    create: z
      .union([
...
export const TaskHistoryValueUpdateManyWithoutGroupNestedInputObjectSchema = Schema;
