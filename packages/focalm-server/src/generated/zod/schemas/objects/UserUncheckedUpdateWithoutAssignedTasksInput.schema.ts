...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutAssignedTasksInput> = z
  .object({
...
export const UserUncheckedUpdateWithoutAssignedTasksInputObjectSchema = Schema;
