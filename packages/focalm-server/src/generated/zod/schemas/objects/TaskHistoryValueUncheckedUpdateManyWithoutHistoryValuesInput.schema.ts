...
const Schema: z.ZodType<Prisma.TaskHistoryValueUncheckedUpdateManyWithoutHistoryValuesInput> = z
  .object({
...
export const TaskHistoryValueUncheckedUpdateManyWithoutHistoryValuesInputObjectSchema = Schema;
