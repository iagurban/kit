...
const Schema: z.ZodType<Prisma.TaskUncheckedUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
...
export const TaskUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema = Schema;
