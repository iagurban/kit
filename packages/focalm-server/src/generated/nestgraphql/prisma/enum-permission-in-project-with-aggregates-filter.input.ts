...
import { NestedEnumPermissionInProjectWithAggregatesFilter } from './nested-enum-permission-in-project-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { PermissionInProject } from './permission-in-project.enum';

@InputType()
export class EnumPermissionInProjectWithAggregatesFilter {
