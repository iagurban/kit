...
import { NestedEnumTaskHistoryOperationWithAggregatesFilter } from './nested-enum-task-history-operation-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { TaskHistoryOperation } from './task-history-operation.enum';

@InputType()
export class EnumTaskHistoryOperationWithAggregatesFilter {
