...
import { UserInProjectUserIdProjectIdPermissionKindCompoundUniqueInput } from './user-in-project-user-id-project-id-permission-kind-compound-unique.input';
import { UserInProjectWhereInput } from './user-in-project-where.input';

@InputType()
export class UserInProjectWhereUniqueInput {
  @Field(() => UserInProjectUserIdProjectIdPermissionKindCompoundUniqueInput, { nullable: true })
  userId_projectId_permission_kind?: UserInProjectUserIdProjectIdPermissionKindCompoundUniqueInput;
