...
import { UploadedFileUpdateOneWithoutUsingItemsNestedInput } from '../uploaded-file/uploaded-file-update-one-without-using-items-nested.input';
...
@InputType()
export class ItemUpdateWithoutChildrenInput {
    ...
    @Field(() => UploadedFileUpdateOneWithoutUsingItemsNestedInput, {nullable:true})
    @Type(() => UploadedFileUpdateOneWithoutUsingItemsNestedInput)
