...
const Schema: z.ZodType<Prisma.RefreshTokenCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const RefreshTokenCreateNestedManyWithoutUserInputObjectSchema = Schema;
