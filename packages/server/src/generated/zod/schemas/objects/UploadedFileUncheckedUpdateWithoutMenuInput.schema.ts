...
const Schema: z.ZodType<Prisma.UploadedFileUncheckedUpdateWithoutMenuInput> = z
  .object({
...
export const UploadedFileUncheckedUpdateWithoutMenuInputObjectSchema = Schema;
