...
const Schema: z.ZodType<Prisma.UploadedFileUncheckedUpdateManyWithoutFilesInput> = z
  .object({
...
export const UploadedFileUncheckedUpdateManyWithoutFilesInputObjectSchema = Schema;
