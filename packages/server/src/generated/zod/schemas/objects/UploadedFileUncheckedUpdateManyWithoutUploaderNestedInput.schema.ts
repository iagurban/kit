...
const Schema: z.ZodType<Prisma.UploadedFileUncheckedUpdateManyWithoutUploaderNestedInput> = z
  .object({
    create: z
      .union([
...
export const UploadedFileUncheckedUpdateManyWithoutUploaderNestedInputObjectSchema = Schema;
