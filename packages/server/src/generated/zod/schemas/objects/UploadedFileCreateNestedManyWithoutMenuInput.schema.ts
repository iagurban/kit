...
const Schema: z.ZodType<Prisma.UploadedFileCreateNestedManyWithoutMenuInput> = z
  .object({
    create: z
      .union([
...
export const UploadedFileCreateNestedManyWithoutMenuInputObjectSchema = Schema;
