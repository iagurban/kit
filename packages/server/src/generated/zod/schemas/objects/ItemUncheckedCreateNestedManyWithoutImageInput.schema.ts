...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateNestedManyWithoutImageInput> = z
  .object({
    create: z
      .union([
...
export const ItemUncheckedCreateNestedManyWithoutImageInputObjectSchema = Schema;
