...
const Schema: z.ZodType<Prisma.UploadedFileUncheckedCreateNestedManyWithoutStoredFileInput> = z
  .object({
    create: z
      .union([
...
export const UploadedFileUncheckedCreateNestedManyWithoutStoredFileInputObjectSchema = Schema;
