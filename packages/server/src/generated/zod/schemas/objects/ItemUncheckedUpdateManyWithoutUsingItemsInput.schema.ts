...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateManyWithoutUsingItemsInput> = z
  .object({
...
export const ItemUncheckedUpdateManyWithoutUsingItemsInputObjectSchema = Schema;
