...
const Schema: z.ZodType<Prisma.UploadedFileUncheckedCreateNestedManyWithoutUploaderInput> = z
  .object({
    create: z
      .union([
...
export const UploadedFileUncheckedCreateNestedManyWithoutUploaderInputObjectSchema = Schema;
