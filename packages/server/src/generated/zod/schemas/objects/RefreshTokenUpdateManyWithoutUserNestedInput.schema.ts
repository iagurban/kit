...
const Schema: z.ZodType<Prisma.RefreshTokenUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const RefreshTokenUpdateManyWithoutUserNestedInputObjectSchema = Schema;
