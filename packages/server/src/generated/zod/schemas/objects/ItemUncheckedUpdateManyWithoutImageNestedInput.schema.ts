...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateManyWithoutImageNestedInput> = z
  .object({
    create: z
      .union([
...
export const ItemUncheckedUpdateManyWithoutImageNestedInputObjectSchema = Schema;
