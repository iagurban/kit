...
const Schema: z.ZodType<Prisma.UploadedFileUncheckedUpdateWithoutUsingItemsInput> = z
  .object({
...
export const UploadedFileUncheckedUpdateWithoutUsingItemsInputObjectSchema = Schema;
