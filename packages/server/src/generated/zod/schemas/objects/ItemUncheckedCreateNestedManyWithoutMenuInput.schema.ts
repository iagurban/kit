...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateNestedManyWithoutMenuInput> = z
  .object({
    create: z
      .union([
...
export const ItemUncheckedCreateNestedManyWithoutMenuInputObjectSchema = Schema;
