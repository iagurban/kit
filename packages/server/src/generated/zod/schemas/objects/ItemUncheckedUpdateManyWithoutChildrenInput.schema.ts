...
const Schema: z.ZodType<Prisma.ItemUncheckedUpdateManyWithoutChildrenInput> = z
  .object({
...
export const ItemUncheckedUpdateManyWithoutChildrenInputObjectSchema = Schema;
