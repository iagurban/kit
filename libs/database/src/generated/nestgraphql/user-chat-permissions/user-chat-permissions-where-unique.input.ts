...
import { UserChatPermissionsUserIdChatIdCompoundUniqueInput } from './user-chat-permissions-user-id-chat-id-compound-unique.input';
import { UserChatPermissionsWhereInput } from './user-chat-permissions-where.input';

@InputType()
export class UserChatPermissionsWhereUniqueInput {
  @Field(() => UserChatPermissionsUserIdChatIdCompoundUniqueInput, { nullable: true })
  userId_chatId?: UserChatPermissionsUserIdChatIdCompoundUniqueInput;
